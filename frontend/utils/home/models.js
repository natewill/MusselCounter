...
/**
 * Load models from the backend and set the models and selected model id
 * @param {*} setModels - function to set the models
 * @param {*} setSelectedModelId - function to set the selected model id
 * @returns - the models list
 * @throws {Error} If the request fails
 */
export async function loadModels(setModels, setSelectedModelId) {
  try {
