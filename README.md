...
**Coverage report:**
After running `pytest --cov`, open `htmlcov/index.html` in a browser to view detailed coverage.
...
import { validateModelId } from '@/utils/validation'
...
describe('validateModelId', () => {
  ...
  it('should reject invalid IDs', () => {
    expect(() => validateModelId(-1)).toThrow()
  })
})
```
